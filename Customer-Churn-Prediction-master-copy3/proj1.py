...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 22 20:09:52 2019

@author: roopashreemunegowda
"""
...
classifier.fit(X_train, y_train,batch_size=2,epochs=200)#UNCOMMENT if not running from saved model
